...
const Footer = () => {
    ...
    return (
        <div className="flex flex-col px-12 py-6 gap-4 bg-gray-700 text-white justify-center items-center">
            <h3 className="font-bold">{APARTMENT_TITLE}</h3>
            <p className="text-gray-400">{APARTMENT_TITLE} | 경상남도 김해시 구산동 583</p>
